...
const Clips = ({ clip, imgsrc }) => {
  return (
    <div className='relative h-28 w-32 rounded-lg overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 xsm:w-12 lg:h-20 md:h-20 sm:h-14'>
      <img
        src={imgsrc}
        alt='img/clips'
